...
## 📜 Mã Script (Loadstring)
Copy đoạn mã bên dưới và dán vào Executor của bạn (Delta, Fluxus, Arceus X...):

```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/quanghub388/Tinytask-for-mobile/main/TinyTask.lua"))()
